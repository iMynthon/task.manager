...
CREATE INDEX idx_user_id_name_tasks ON tasks(user_id,name);
CREATE INDEX idx_incomplete_user_tasks ON tasks(user_id) WHERE is_completed = false;

CREATE INDEX idx_time_reminder ON reminders(user_id,time);
